%T= readtable('E:\AAA\table\FEATURES.csv',"VariableNamingRule","preserve");
%//disclaimer: copy above line and run it in command window when u start fresh;
%//after 1 extraction pla add % before the first line.
m= length(O1);
sum=0;
for k=1:m-1
...
cellss = {C01,C02,C03,C011,C012,C013,C1,C2,C3,C4,C5,C6,C7,C8,C9,C10,C11,C12,C13,C14,CD};
T = [T;cellss];

%writetable(T,'E:\AAA\table\FEATURES.csv');
%// use this only when u r going to close matlab
%copy paste in command window & run
